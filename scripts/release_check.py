...
REQUIRED_PATHS = (
    ...
    ".github/workflows/trending-smoke.yml",
    ...
    "VERSION",
    "agents/openai.yaml",
    "evals/report-behavior.md",
    "examples/sample-daily-report.md",
    "examples/sample-daily-report.en.md",
    "examples/sample-profile.json",
    "examples/sample-snapshot.json",
